...
class CandidateController extends Controller {
	...
	public function showAllCandidateAdmin(){
			...
			$candidates = Candidate_details::leftJoin('cities', 'cities.id', '=', 'candidate_details.city_id')
				...
				->leftJoin('work_experiences', 'work_experiences.id', '=', 'candidate_details.work_experience')
				->leftJoin('notice_periods', 'notice_periods.id', '=', 'candidate_details.notice_period')
				->select('candidate_details.id', 'candidate_details.name', 'candidate_details.email', 'candidate_details.mobile_number', 'candidate_details.alternate_number', 'candidate_details.permanent_address', 'candidate_details.current_address', 'candidate_details.job_title', 'candidate_details.job_keywords', 'candidate_details.state_id', 'states.name as state_name', 'cities.name as city_name', 'work_experiences.name as work_experience', 'candidate_details.last_ctc', 'candidate_details.skills', 'candidate_details.describe_job_profile', 'notice_periods.name as notice_period', 'candidate_details.image', 'candidate_details.user_id','candidate_details.resume_file','candidate_details.status as candidate_status','candidate_details.is_deleted as candidate_is_deleted')
				->paginate(10);
