            ...
            <div class="container pt-120 pb-70">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-50">
                        <div class="demo-item">
                            <a href="{{ url('/employment')}}" class="image">
                                <img src="{{ asset('public/main-home-page/img/demo/page-index1.jpg')}}" alt="I want Employment">
                                <i class="icon-magnifying-glass"></i>
                            </a>
                            <h4 class="title"><a href="{{ url('/employment')}}">I want Employment</a></h4>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-50">
                        <div class="demo-item">
                            <a href="{{ url('/login')}}" class="image">
                                <img src="{{ asset('public/main-home-page/img/demo/page-about-us.jpg')}}" alt="I want Employee">
                                <i class="icon-magnifying-glass"></i>
                            </a>
                            <h4 class="title"><a href="{{ url('/login')}}">I want Employee</a></h4>
                        </div>
                    </div>					
