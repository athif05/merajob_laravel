...
@section("title")
    ...
    <title>Edit Job | {{ env('MY_SITE_NAME') }}</title>
...
@section("content")
  ...
  <main class="main-content">
    ...
    <form method="post" action="{{ route('update-job.update')}}" id="myForm" enctype="multipart/form-data">
        @csrf
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="job_title" id="job_title" maxlength="50" value="{{ $job_detail['job_title'] }}" placeholder="Job Title">
			...
			<div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="salary" id="salary" value="{{ $job_detail['salary'] }}" maxlength="10" placeholder="Salary">
			...
			<div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="no_of_opening" id="no_of_opening" maxlength="5" value="{{ $job_detail['no_of_opening'] }}" placeholder="No of Opening">
        ...
        <div class="row">
			<div class="form-group col-md-4">
                ...
                <select class="form-control" name="job_location_id" id="job_location_id">
					...
					<option value="{{ $job_location['id']}}" @if($job_detail['job_location_id']==$job_location['id']) selected @endif>{{ $job_location['name']}}</option>
					@endforeach
				</select>
			...
			<div class="form-group col-md-4">
				...
				<select class="form-control" name="state_id" id="state_id" >
					...
					<option value="{{ $states_name['id']}}" @if($job_detail['state_id']==$states_name['id']) selected @endif>{{ $states_name['name']}}</option>
					@endforeach
				</select>
			...
			<div class="form-group col-md-4">
				...
				<select class="form-control" name="city_id" id="city_id" >
					...
					@if(!empty($job_detail['city_id'])) 
						@foreach($job_locations as $job_location)
						<option value="{{ $job_location['id']}}" @if($job_detail['city_id']==$job_location['id']) selected @endif>
							{{ $job_location['name']}} 
						</option>
						@endforeach
					@else 
			...
			<div class="form-group col-md-4">
			  ...
			  <textarea class="form-control" name="job_description" id="job_description" maxlength="500" placeholder="Job Description">{{$job_detail['job_description']}}</textarea>
			...
			<div class="form-group col-md-4">
			  ...
			  <textarea class="form-control" name="job_responsibilities" id="job_responsibilities" maxlength="500" placeholder="Job Responsibilities">{{$job_detail['job_responsibilities']}}</textarea>
			...
			<div class="form-group col-md-4">
			  ...
			  <textarea class="form-control" name="job_requirements" id="job_requirements" maxlength="500" placeholder="Job Requirements ">{{$job_detail['job_requirements']}}</textarea>
		...
		<div class="row">
            <div class="form-group col-md-4">
				...
				<select class="form-control" name="job_category_id" id="job_category_id" >
					...
					<option value="{{ $main_job_categorie['id']}}" @if($job_detail['job_category_id']==$main_job_categorie['id']) selected @endif>
			...
			<div class="form-group col-md-4">
				...
				<select class="form-control" name="types_of_job_id" id="types_of_job_id" >
					...
					<option value="{{ $job_categorie['id']}}" @if($job_detail['types_of_job_id']==$job_categorie['id']) selected @endif>
						{{ $job_categorie['name']}}
					</option>
					@endforeach
				</select>
			...
			<div class="form-group col-md-4">
				...
				<select class="form-control" name="working_days" id="working_days">
					...
					<option value="{{ $working_day['id']}}" @if($job_detail['working_days']==$working_day['id']) selected @endif>
						{{ $working_day['name']}} 
					</option>
					@endforeach
				</select>
			...
			<div class="form-group col-md-4">
			  ...
			  <input type="text" class="form-control" id="working_hours" name="working_hours" class="form-control" value="{{$job_detail['working_hours']}}" placeholder="Working Hours" maxlength="15">
			...
			<div class="form-group col-md-4">
			    ...
			    <select class="form-control" name="experience_required" id="experience_required">
					<option value="Fresher" @if($job_detail['experience_required']=='Fresher') selected @endif>Fresher</option>
					<option value="Experience" @if($job_detail['experience_required']=='Experience') selected @endif>Experience</option>
				</select>
			    @if ($errors->has('experience_required'))
					<span class="text-danger">{{ $errors->first('experience_required') }}</span>
				@endif
				
				@if(!empty($job_detail['experience_required']) && ($job_detail['experience_required']=='Experience'))
				...
				@endif
					...
					<div style="float:left; width:49%;">
						...
						<input type="text" class="form-control" id="min_experience_required" name="min_experience_required" class="form-control" value="{{$job_detail['min_experience_required']}}" style="padding: 8px 6px;" placeholder="Min Experience">
					...
					<div style="float:right; width:49%;">
						...
						<input type="text" class="form-control" id="max_experience_required" name="max_experience_required" class="form-control" value="{{$job_detail['max_experience_required']}}" style="padding: 8px 6px;" placeholder="Max Experience">
			...
			<div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="ctc" name="ctc" class="form-control" value="{{$job_detail['ctc']}}" maxlength="8" style="padding: 8px 6px;" placeholder="CTC">
			  @if ($errors->has('ctc'))
			...
			<div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="skills" data-role="tagsinput" name="skills" class="form-control" value="{{$job_detail['skills']}}" style="padding: 8px 4px;"  placeholder="Skills">
			  <div class="skills-msg"></div>
			  @if ($errors->has('skills'))
				<span class="text-danger">{{ $errors->first('skills') }}</span>
			@endif
            </div>
			<?php $qualification_ids=explode(',',$job_detail['qualification_ids']);?>
			<div class="form-group col-md-4">
				...
				<select class="form-control" name="qualification_ids[]" id="qualification_ids" multiple>
					...
					<option value="{{ $qualification['id']}}" @if(!empty($job_detail['qualification_ids']) && (in_array($qualification['id'], $qualification_ids))) selected @endif>
						{{ $qualification['name']}}
					</option>
					@endforeach
				</select>
			...
			<div class="form-group col-md-4">
			  ...
			  &nbsp; &nbsp; &nbsp;<input type="radio" name="gender" value="Male" class="form-check-input" @if($job_detail['gender']=='Male') checked @endif> Male &nbsp; &nbsp; &nbsp;
			  <input type="radio" name="gender" value="Female" class="form-check-input" @if($job_detail['gender']=='Female') checked @endif> Female  &nbsp; &nbsp; &nbsp;
			  <input type="radio" name="gender" value="Both" class="form-check-input" @if($job_detail['gender']=='Both') checked @endif> Both
			  @if ($errors->has('gender'))
				<span class="text-danger">{{ $errors->first('gender') }}</span>
				@endif
            </div>
			
			<?php $candidate_requirements=explode(',',$job_detail['candidate_requirements']);?>
			
			<div class="form-group col-md-12">
                <label for="Goal Score">Candidate Requirements:</label>
			    &nbsp; &nbsp; &nbsp;
				<input type="checkbox" name="candidate_requirements[]" value="Smartphone" class="form-check-input" @if(!empty($job_detail['candidate_requirements']) && (in_array('Smartphone', $candidate_requirements))) checked @endif> Smartphone &nbsp; &nbsp; &nbsp;
				<input type="checkbox" name="candidate_requirements[]" value="Computer/Laptop" class="form-check-input" @if(!empty($job_detail['candidate_requirements']) && (in_array('Computer/Laptop', $candidate_requirements))) checked @endif> Computer/Laptop  &nbsp; &nbsp; &nbsp;
				<input type="checkbox" name="candidate_requirements[]" value="Wi-Fi/Internet" class="form-check-input" @if(!empty($job_detail['candidate_requirements']) && (in_array('Wi-Fi/Internet', $candidate_requirements))) checked @endif> Wi-Fi/Internet  &nbsp; &nbsp; &nbsp;
				<input type="checkbox" name="candidate_requirements[]" value="PAN Card" class="form-check-input" @if(!empty($job_detail['candidate_requirements']) && (in_array('PAN Card', $candidate_requirements))) checked @endif> PAN Card  &nbsp; &nbsp; &nbsp;
				<input type="checkbox" name="candidate_requirements[]" value="Adhar Card" class="form-check-input" @if(!empty($job_detail['candidate_requirements']) && (in_array('Adhar Card', $candidate_requirements))) checked @endif> Adhar Card  &nbsp; &nbsp; &nbsp;
				<input type="checkbox" name="candidate_requirements[]" value="DL" class="form-check-input" @if(!empty($job_detail['candidate_requirements']) && (in_array('DL', $candidate_requirements))) checked @endif> DL  &nbsp; &nbsp; &nbsp;
				<input type="checkbox" name="candidate_requirements[]" value="Two Wheelers" class="form-check-input" @if(!empty($job_detail['candidate_requirements']) && (in_array('Two Wheelers', $candidate_requirements))) checked @endif> Two Wheelers
            </div>
		...
		<div class="row">
			...
			<div class="form-group col-md-7">
			  ...
			  &nbsp; &nbsp; &nbsp;
				<input type="radio" name="english_required" value="No English" class="form-check-input" @if($job_detail['english_required']=='No English') checked @endif> No English &nbsp; &nbsp; &nbsp;
				<input type="radio" name="english_required" value="Basic English" class="form-check-input" @if($job_detail['english_required']=='Basic English') checked @endif> Basic English  &nbsp; &nbsp; &nbsp;
				<input type="radio" name="english_required" value="Good English" class="form-check-input" @if($job_detail['english_required']=='Good English') checked @endif> Good English  &nbsp; &nbsp; &nbsp;
				<input type="radio" name="english_required" value="Excellent/Fluent English" class="form-check-input" @if($job_detail['english_required']=='Excellent/Fluent English') checked @endif> Excellent/Fluent English
		...
		<div class="row">
			...
			<div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="interview_information_company_name" name="interview_information_company_name" class="form-control" value="{{$job_detail['interview_information_company_name']}}" style="padding: 8px 6px;" placeholder="Company Name">
			...
			<div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="interview_information_hr_name" name="interview_information_hr_name" class="form-control" value="{{$job_detail['interview_information_company_name']}}" style="padding: 8px 6px;" placeholder="HR Name">
			...
			<div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="interview_information_hr_number" name="interview_information_hr_number" class="form-control" value="{{$job_detail['interview_information_hr_number']}}" style="padding: 8px 6px;" maxlength="10" placeholder="HR Contact No">
		...
		<div class="row">
			...
			<div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="interview_information_hr_email" name="interview_information_hr_email" class="form-control" value="{{$job_detail['interview_information_hr_email']}}" style="padding: 8px 6px;" placeholder="HR Email">
		...
		<div class="row">
			...
			<div class="form-group col-md-4">
			  ...
			  <textarea class="form-control" name="job_address_flat_address" id="job_address_flat_address" maxlength="500" placeholder="Full Address">{{$job_detail['job_address_flat_address']}}</textarea>
			...
			<div class="form-group col-md-4">
				...
				<select class="form-control" name="job_address_state" id="job_address_state" >
					...
					<option value="{{ $states_name['id']}}" @if($job_detail['job_address_state']==$states_name['id']) selected @endif>{{ $states_name['name']}}</option>
					@endforeach
				</select>
			...
			<div class="form-group col-md-4">
				...
				<select class="form-control" name="job_address_city" id="job_address_city" >
					...
					@if(!empty($job_detail['job_address_city'])) 
						@foreach($job_locations as $job_location)
						<option value="{{ $job_location['id']}}" @if($job_detail['job_address_city']==$job_location['id']) selected @endif>
							{{ $job_location['name']}} 
						</option>
						@endforeach
					@else 
		...
		<div class="row">
			...
			<div class="form-group col-md-4">
              <label for="Goal Score">Full Address: <span class="error-msg-star">*</span></label>
			  <textarea class="form-control" name="interview_address_full_address" id="interview_address_full_address" maxlength="500" placeholder="Full Address">{{$job_detail['interview_address_full_address']}}</textarea>
			...
			<div class="form-group col-md-4">
				...
				<select class="form-control" name="interview_address_state" id="interview_address_state" >
					...
					<option value="{{ $states_name['id']}}" @if($job_detail['interview_address_state']==$states_name['id']) selected @endif>{{ $states_name['name']}}</option>
					@endforeach
				</select>
			...
			<div class="form-group col-md-4">
				...
				<select class="form-control" name="interview_address_city" id="interview_address_city" >
					...
					@if(!empty($job_detail['interview_address_city'])) 
						@foreach($job_locations as $job_location)
						<option value="{{ $job_location['id']}}" @if($job_detail['interview_address_city']==$job_location['id']) selected @endif>
							{{ $job_location['name']}} 
						</option>
						@endforeach
					@else 
		...
		<div class="row">
			...
			<div class="form-group col-md-6">
				<label for="Goal Score">If there any fee charged to the candidate?:{{$job_detail['candidate_fee_charged']}}</label>
				<select class="form-control" name="candidate_fee_charged" id="candidate_fee_charged" >
					<option value="No" @if($job_detail['candidate_fee_charged']=="No") selected @endif>No</option>
					<option value="Yes" @if($job_detail['candidate_fee_charged']=="Yes") selected @endif>Yes</option>
				</select>
			...
			@if(!empty($job_detail['candidate_fee_charged']) && ($job_detail['candidate_fee_charged']=='Yes'))
			...
			@endif
				<div style="float:left; width:100%;">
					...
					<div style="float:left; width:49%;">
						...
						<input type="text" class="form-control" id="candidate_fee_amount" name="candidate_fee_amount" class="form-control" value="{{$job_detail['candidate_fee_amount']}}" style="padding: 8px 6px;" placeholder="Fee Amount">
					...
					<div style="float:right; width:49%;">
						...
						<select class="form-control" name="candidate_fee_reasons" id="candidate_fee_reasons" >
							...
							<option value="{{$fee_charged_reason['id']}}" @if($job_detail['candidate_fee_reasons']==$fee_charged_reason['id']) selected @endif>{{$fee_charged_reason['name']}}</option>
							@endforeach
						</select>
						...
						@if(!empty($job_detail['candidate_fee_reasons']) && ($job_detail['candidate_fee_reasons']=='5'))
						...
						@endif
							<div style="float:left; width:100%;">
								...
								<textarea class="form-control" name="candidate_fee_other_reasons" id="candidate_fee_other_reasons" maxlength="500" placeholder="Specify Other Reason">{{$job_detail['candidate_fee_other_reasons']}}</textarea>
      ...
      <div class="modal-footer">
        ...
        <button  class="btn btn-success" id="submit-btn">Update Job</button>
